        ...
        if ($this->request->ajax()) {
            ...
            return DataTables::of($fishes)
                ...
                ->addColumn('stock_input', function ($data) {  // Add a column for stock input field
                    return '<input type="number" class="form-control edit-stock" style="min-width: 70px !important;" data-id="' . $data->id_koi_stock . '" value="' . $data->stock . '">';
                })
                ->addColumn('weight_input', function ($data) {  // Add a column for weight input field
                    return '<input type="number" class="form-control edit-weight" style="min-width: 70px !important;" data-id="' . $data->id_koi_stock . '" value="' . $data->weight . '">';
                })
