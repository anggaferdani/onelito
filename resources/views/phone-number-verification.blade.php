...
<div class="container w-75">
    ...
    <div class="row">
        <center>
            <div class="mb-3"><h2>Verifikasi Nomor Telepon</h2></div>
            <div class="" style="color:grey">Kami telah mengirimkan kode verifikasi ke nomor telepon Anda melalui WhatsApp. Silakan periksa pesan WhatsApp Anda dan masukkan kodenya untuk melanjutkan.</div>
        </center>
    </div>
    <br>
    <br>
    <br>
    <form method="POST" action="{{ route('post-phone-number-verification', ['token' => $member->verification_token]) }}">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="row">
